                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <form class="form-horizontal form-label-left " action="" method="post"
                                        ...
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">نام شبه
                                                <span
                                                    class="required">*</span>
                                            </label>
                                        ...
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="location">آدرس
                                                 <span
                                                    class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="location" class="form-control col-md-7 col-xs-12"
                                                       data-validate-length-range="6" data-validate-words="2"
                                                       name="location"
                                                       value="{{ old('location',isset($item) ? $item->location: '') }}"
                                                       required="required" type="text">
                                            </div>
                                        </div>

                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="admin">مدیریت  <span
                                                    class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="admin" class="form-control col-md-7 col-xs-12"
                                                       data-validate-length-range="6" data-validate-words="2"
                                                       name="admin"
                                                       value="{{ old('location',isset($item) ? $item->admin: '') }}"
                                                       required="required" type="text">
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="panel panel-info text-center ">
                                        ...
                                        <div class="panel-body  ">
                                            <img class="img-responsive img-rounded justify-content-center image center-margin"  name="picture" alt="تصویر بازی " src="{{old('picture' , isset($item)? asset('storage/images/branches').'/'.$item->pic:'')}}" >
