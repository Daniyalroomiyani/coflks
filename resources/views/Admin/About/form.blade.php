                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <form class="form-horizontal form-label-left " action="" method="post"
                                        ...
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="tittle">نام قسمت
                                                <span
                                                    class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="tittle" readonly class="form-control col-md-7 col-xs-12"
                                        ...
                                        <div class="item form-group">
                                            <label for="showstatckeck" class="control-label col-md-3">نمایش </label>

                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                @if(isset($item) && $item->showstat)
                                                    <input type="checkbox"  id="showstatckeck" name="showstatckeck"  checked/>
                                                @else
                                                    <input type="checkbox"  id="showstatckeck" name="showstatckeck" />
                                                @endif
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="panel panel-info text-center ">
                                        ...
                                        <div class="panel-body  ">
                                            <img class="img-responsive img-rounded justify-content-center image center-margin"  name="picture" alt="تصویر بازی " src="{{old('picture' , isset($item)? asset('storage/images/abouts').'/'.$item->pic:'')}}" >
