                            ...
                            <div role="tabpanel" class="tab-pane fade active in" id="tab_content1"
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <form class="form-horizontal form-label-left " action="" method="post"
                                        ...
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="rules">شرایط
                                                بازی <span
                                                    class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <textarea name="rules" id="rules"
                                                          class="form-control col-md-7 col-xs-12" rows="10"
                                                          required="required" type="text">{{ old('rules',isset($item) ? $item->rules: '') }}</textarea>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="panel panel-info text-center ">
                                        ...
                                        <div class="panel-body  ">
                                            <img class="img-responsive img-rounded justify-content-center image center-margin"  name="picture" alt="تصویر بازی " src="{{old('picture' , isset($item)? asset('storage/images/boardgames').'/'.$item->pic:'')}}" >
